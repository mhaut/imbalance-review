...
def get_model_compiled(n_bands, num_class, hsize = None):
    ...
    clf.add(Dense(int(hsize*2/3.)+10, activation='relu'))
...
def main():
    ...
    _, x_val, _, y_val = train_test_split(x_test, y_test, test_size=0.2)
    ...
    print("DEEPMLP", args.dataset, args.tr_percent, args.oversampling, args.random_state, list(miresult[2]))
    print(miresult[3])
