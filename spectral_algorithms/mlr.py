...
def main():
    ...
    if args.dataset in ["UH", "DIP", "DUP", "DIPr", "DUPr"]:
        ...
        if args.oversampling == "None":
            ...
            #num_components = x_train.shape[-1] // 2
    ...
    print("MLR", args.dataset, args.tr_percent, args.oversampling, args.random_state, list(miresult[2]))
    print(miresult[3])
